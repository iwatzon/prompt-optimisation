...
MODEL_LIST = {
    ...
    PaLMModel: ['palm'],
    OpenAIModel: ['gpt-3.5-turbo', 'gpt-4', 'gpt-4-1106-preview', 'gpt-3.5-turbo-1106', 'gpt-4-0125-preview', 'gpt-3.5-turbo-0125', 'gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
    ...
    ChatOllamaModel: ['mistral:v0.3', 'llama3.1'],
}
MODEL_LIST_VLM = {
